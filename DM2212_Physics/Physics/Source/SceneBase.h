...
public:
	...
	enum GEOMETRY_TYPE
	{
		...
		GEO_JUNGLE_CACTUS = 203,
		GEO_JUNGLE_FENCE = 204,
		GEO_JUNGLE_PINETREE = 205,

		GEO_OCEAN_WHALE = 206,
		GEO_OCEAN_YH = 207,
		GEO_OCEAN_BOTTLE = 208,

		GEO_SETTINGS_MACHINE = 209,
		GEO_LOBBY_LEVELEDITOR = 210,
...
public:
	...
	void RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y, float z, int(&charWidth)[256], int arrSize);
