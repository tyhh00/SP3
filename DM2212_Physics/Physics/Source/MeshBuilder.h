...
public:
	...
	static Mesh* GenerateCircle(const std::string& meshName, float radius, Color col);
	...
	static SpriteAnimation* GenerateSpriteAnimation(unsigned numRow, unsigned numCol, float tile_width = 1.0f, float tile_height = 1.0f);
};
