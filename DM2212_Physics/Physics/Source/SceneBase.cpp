...
void SceneBase::Init()
{
	...
	LoadTile(GEO_JUNGLE_TREE_B0TTOM_LEFT, "JUNGLE_TREE_BOTTOM_LEFT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_BOTTOM_RIGHT, "JUNGLE_TREE_BOTTOM_RIGHT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_BRANCH_1, "JUNGLE_TREE_BRANCH_1.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_BRANCH_2, "JUNGLE_TREE_BRANCH_2.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_BRANCH_BASE, "JUNGLE_TREE_BRANCH_BASE.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_CENTER, "JUNGLE_TREE_CENTER.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_INTERSECTION, "JUNGLE_TREE_INTERSECTION.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_MIDDLE, "JUNGLE_TREE_MIDDLE.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_MIDDLE_BOTTOM, "JUNGLE_TREE_MIDDLE_BOTTOM.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_MIDDLE_LEFT, "JUNGLE_TREE_MIDDLE_LEFT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_MIDDLE_RIGHT, "JUNGLE_TREE_MIDDLE_RIGHT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_MIDDLE_TOP, "JUNGLE_TREE_MIDDLE_TOP.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_TOP, "JUNGLE_TREE_TOP.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_TOP_LEFT, "JUNGLE_TREE_TOP_LEFT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_JUNGLE_TREE_TOP_RIGHT, "JUNGLE_TREE_TOP_RIGHT.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	...
	LoadTile(GEO_OCEAN_TREE2, "OCEAN_coconutTree2.tga", 3, 3, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_OCEAN_SIGN, "OCEAN_dangerSign.tga", 1, 1, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_OCEAN_SANDCASTLE, "OCEAN_sandCastle.tga", 2, 2, SHAPE_TYPE::RECTANGLE);
	LoadTile(GEO_OCEAN_SEASHELL1, "OCEAN_seashell1.tga", 0.5, 0.5, SHAPE_TYPE::RECTANGLE);
	...
	LoadTile(GEO_OCEAN_CORAL, "OCEAN_coral.tga", 3, 3, SHAPE_TYPE::RECTANGLE);
...
void SceneBase::RenderTextOnScreen(Mesh* mesh, std::string text, Color color, float size, float x, float y, float z, int(&charWidth)[256], int arrSize)
{
	if (!mesh || mesh->textureID <= 0) //Proper error check
		return;
